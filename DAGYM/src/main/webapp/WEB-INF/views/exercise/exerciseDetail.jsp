          ...
          <div class="row">
          	...
          	<div class="row">
				<div class="col-lg-12">    
						...
						<caption>${exe_date}일의 운동기록</caption>
							...
							<tr>
								...
								<div class="align-center">
									<input type="button" value="수정" onclick="location.href='exerciseModifyForm.do?exe_num=${exercise.exe_num}'">
								</div>
								</td>
							</tr>
							</c:forEach>
					...
					<div class="align-center">
						<input type="button" value="확인" onclick="location.href='${pageContext.request.contextPath}/exercise/exerciseList.do?client_num=${param.client_num}'">
					</div>
					<!-- content 끝 -->
