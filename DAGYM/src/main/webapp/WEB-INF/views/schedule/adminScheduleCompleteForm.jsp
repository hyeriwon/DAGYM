          ...
          <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">    
                    ...
                    <!-- content 시작 -->
                    <form action="${pageContext.request.contextPath}/schedule/adminScheduleComplete.do" method="post">
                        ...
                        <ul>
                            ...
                            <li>
                            	<label for="tra_name">트레이너ID</label>
                                <input type="text" name="tra_name" id="tra_name" value="${param.trainer_id}" readonly>
                            </li>
                            
                            
                            <li>
                            	<label for="tra_name">회원ID</label>
                                <input type="text" name="mem_name" id="mem_name" value="${param.member_id}" readonly>
                            </li>
                            <li>
                        ...
                        <div class="align-center">
                            <input type="submit" value="PT완료">
                            <input type="button" value="PT취소" onclick="location.href='${pageContext.request.contextPath}/history/adminHistoryDeleteForm.do?sch_num=${param.his_num}'">
                            <input type="button" value="목록" onclick="location.href='${pageContext.request.contextPath}/history/adminHistoryList.do'">
                        </div>
                    </form>
                    <!-- content 끝 -->
                    </div>
