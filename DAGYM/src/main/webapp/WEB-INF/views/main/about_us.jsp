        ...
        <div class="container">
            ...
            <div class="row">
                <div class="ts-slider owl-carousel">
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="${pageContext.request.contextPath}/img/team/team-4.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
            ...
            <div class="ts_slider owl-carousel">
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="ti_pic">
                                <img src="${pageContext.request.contextPath}/resources/img/testimonial/testimonial-1.jpg" alt="">
                            </div>
                            <div class="ti_text">
                ...
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="ti_pic">
                                <img src="${pageContext.request.contextPath}/resources/img/testimonial/testimonial-2.jpg" alt="">
                            </div>
                            <div class="ti_text">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt<br /> ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
